...
QT_MOC_LITERAL(8, 95, 9), // "Set_Image"
QT_MOC_LITERAL(9, 105, 7) // "cv::Mat"

    },
    "FRONT_CAMERA\0Get_Image_Capture_Mode\0"
    "\0_cap_mode\0_save_mode\0_path\0"
    "Click_Start_Button\0File_Dialog\0Set_Image\0"
    "cv::Mat"
};
#undef QT_MOC_LITERAL
...
void FRONT_CAMERA::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->Set_Image((*reinterpret_cast< cv::Mat(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
