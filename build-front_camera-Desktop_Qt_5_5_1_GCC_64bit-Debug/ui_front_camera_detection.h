...
public:
    ...
    void setupUi(QWidget *frontcamera_dlg)
    {
        ...
        rd_input_mode_net->setChecked(true);
        ...
        rd_input_mode_usb->setChecked(false);
        ...
        ck_mission_signal->setChecked(true);
        ...
        ck_mission_sign->setChecked(true);
        ...
        ck_mission_dummy_car->setChecked(true);
        ...
        ck_mission_normal_car->setChecked(true);
