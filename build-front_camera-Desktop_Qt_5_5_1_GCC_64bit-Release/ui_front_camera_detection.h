...
public:
    ...
    void setupUi(QWidget *frontcamera_dlg)
    {
        ...
        frontcamera_dlg->resize(913, 829);
        ...
        graphicsView = new QGraphicsView(traffic_signal);
        graphicsView->setObjectName(QStringLiteral("graphicsView"));
        graphicsView->setGeometry(QRect(10, 60, 256, 41));
        label_4 = new QLabel(traffic_signal);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(10, 110, 51, 17));
        graphicsView_2 = new QGraphicsView(traffic_signal);
        graphicsView_2->setObjectName(QStringLiteral("graphicsView_2"));
        graphicsView_2->setGeometry(QRect(10, 140, 61, 41));
        lineEdit = new QLineEdit(traffic_signal);
        lineEdit->setObjectName(QStringLiteral("lineEdit"));
        lineEdit->setGeometry(QRect(90, 140, 81, 27));
        ...
        graphicsView_3->setGeometry(QRect(10, 60, 101, 81));
        ...
        graphicsView_4 = new QGraphicsView(groupBox_4);
        graphicsView_4->setObjectName(QStringLiteral("graphicsView_4"));
        graphicsView_4->setGeometry(QRect(10, 60, 121, 221));
        ...
        checkBox_2->setGeometry(QRect(120, 20, 111, 22));
        checkBox_3 = new QCheckBox(groupBox_5);
        checkBox_3->setObjectName(QStringLiteral("checkBox_3"));
        checkBox_3->setGeometry(QRect(0, 40, 101, 22));
    ...
    void retranslateUi(QWidget *frontcamera_dlg)
    {
        ...
        checkBox->setText(QApplication::translate("frontcamera_dlg", "Traffic Signal", 0));
        checkBox_2->setText(QApplication::translate("frontcamera_dlg", "Traffic Sign", 0));
        checkBox_3->setText(QApplication::translate("frontcamera_dlg", "Pedestrian", 0));
    } // retranslateUi
